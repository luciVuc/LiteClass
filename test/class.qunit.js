  ...
  */
  ...
  QUnit.module("LiteClass", function(hooks) {
    ...
    QUnit.test("'LiteClass' should be instantiatable", function(assert) {
      ...
      assert.ok( LiteClass.getIdOf(test) === test.getUID(), "'getIdOf' and 'getUID' is the same" );
      
      var testId = test.getUID();
      test.destroy();
      test = null;
      assert.ok( LiteClass.getInstanceById(testId) === undefined, "'getInstanceById' returns 'undefined' for an ID whose object has been destroyed" );
    ...
    QUnit.test("Method aliases work", function (assert) {
      var test = new LiteClass();
      
      assert.ok( test.init === test.initialize, "'init' is an alias for 'initialize'");
      assert.ok( test.set === test.setProperty, "'set' is an alias for 'setProperty'");
      assert.ok( test.toHashMap === test.getAggregationAsHashMap, "'toHashMap' is an alias for 'getAggregationAsHashMap'");
      assert.ok( test.at === test.getAggregationAt, "'at' is an alias for 'getAggregationAt'");
      assert.ok( test.indexOf === test.indexOfAggregation, "'indexOf' is an alias for 'indexOfAggregation'");
      assert.ok( test.add === test.addAggregation, "'add' is an alias for 'addAggregation'");
      assert.ok( test.addFirst === test.addFirstAggregation, "'addFirst' is an alias for 'addFirstAggregation'");
      assert.ok( test.insertAt === test.insertAtAggregation, "'insertAt' is an alias for 'insertAtAggregation'");
      assert.ok( test.removeFirst === test.removeFirstAggregation, "'removeFirst' is an alias for 'removeFirstAggregation'");
      assert.ok( test.removeLast === test.removeLastAggregation, "'removeLast' is an alias for 'removeLastAggregation'");
      assert.ok( test.remove === test.removeAggregation, "'remove' is an alias for 'removeAggregation'");
      assert.ok( test.removeAt === test.removeAggregationAt, "'removeAt' is an alias for 'removeAggregationAt'");
      assert.ok( test.removeAll === test.removeAllAggregation, "'removeAll' is an alias for 'removeAllAggregation'");
      assert.ok( test.apply === test.applySettings, "'apply' is an alias for 'applySettings'");
    });
  });
});